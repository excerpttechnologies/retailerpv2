...
// /* Print Label - /admin/inventory/barcode-print
//    Also reached as ?grc=<id> from Action ▾ -> Barcode Print on the GRC list.
//    useSearchParams needs a Suspense boundary. */

// export default function BarcodePrintPage() {
//   return (
//     <Suspense fallback={<div className="card"><div className="card-body"><span className="spin" /></div></div>}>
//       <BarcodePrintLabel />
//     </Suspense>
//   );
// }
