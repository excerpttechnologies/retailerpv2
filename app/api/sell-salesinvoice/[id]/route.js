...
/* /api/sell-salesinvoice/<id> - read one, update, delete. */
...
export async function GET(req, { params }) {
  ...
  const doc = await SalesInvoice.findById(id).lean();
...
export async function PUT(req, { params }) {
  ...
  delete doc.salesInvoiceNo;

  const updated = await SalesInvoice.findByIdAndUpdate(id, doc, { new: true, runValidators: true });
