...
/* /api/sell-salereturn - list + create. */
...
export async function POST(req) {
  ...
  if (!doc.salesReturnNo) {
    doc.salesReturnNo = await nextDocNumber(SalesReturn, 'salesReturnNo', "Sales Return", {
      businessId: doc.businessId, locationId: doc.locationId, finYear: doc.finYear,
    });
  }

  const created = await SalesReturn.create(doc);
