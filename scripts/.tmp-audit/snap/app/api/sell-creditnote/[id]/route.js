...
/* /api/sell-creditnote/<id> - read one, update, delete. */
...
export async function PUT(req, { params }) {
  ...
  delete doc.creditNoteCode;

  const updated = await CreditNote.findByIdAndUpdate(id, doc, { new: true, runValidators: true });
